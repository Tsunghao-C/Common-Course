...
/*   Updated: 2024/05/27 16:21:27 by tsuchen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_print_spec_f(char c, va_list *ap, char *flags, char **wid_pre)
{
	...
	/*else if (c == 'd' || c == 'i')
		...
		count += ft_print_digit_f(va_arg(*ap, unsigned int), DEC_TAB, flags, wid_pre);
	else if (c == 'x')
		count += ft_print_digit(va_arg(*ap, unsigned int), HEX_TAB, flags, wid_pre);
	else if (c == 'X')
		count += ft_print_digit(va_arg(*ap, unsigned int), HEX_TAB_U, flags, wid_pre);*/
	else
